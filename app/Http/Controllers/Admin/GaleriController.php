...
{
    private string $kategoriTetap = 'Hutaginjang';
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('gambar')) {
            if ($galeri->gambar && !str_starts_with($galeri->gambar, 'data:') && !str_starts_with($galeri->gambar, 'http')) {
