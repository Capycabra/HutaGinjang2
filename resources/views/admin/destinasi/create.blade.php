            ...
            <div class="row g-3">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                           value="{{ old('nama') }}" placeholder="Contoh: Bukit Beta Huta Ginjang" required>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-text">Pilih kategori: Alam, Buatan, atau Budaya.</div>
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" name="lokasi" class="form-control @error('lokasi') is-invalid @enderror"
                           value="{{ old('lokasi') }}" placeholder="Contoh: Huta Ginjang, Danau Toba" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="url" class="form-control @error('url') is-invalid @enderror"
                           value="{{ old('url') }}" placeholder="Contoh: /geosite/huta-ginjang">
