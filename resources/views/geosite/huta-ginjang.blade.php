...
<!-- HERO -->
<section class="hero" style="background-image: url('/image/hutaginjang/hutaginjang_1.jpg'); margin-top: -60px; padding-top: 120px;">
    <div>
    ...
    <div class="container">
        ...
        <div class="galeri-grid" id="galeriGrid">
            ...
            <div class="galeri-item galeri-tab-{{ $tabIdx }}"@if($tabIdx !== 0) style="display:none"@endif>
                <img src="{{ $foto->gambar }}" alt="{{ $foto->judul }}" loading="lazy" style="cursor:pointer;">
            </div>
            @endforeach
        </div>
        @else
