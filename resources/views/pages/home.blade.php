...
<style>
    ...
    .hero-section::after {
        ...
        right: 0;
        height: 120px;
        background: linear-gradient(to top, #e0ecf7, transparent);
        z-index: 5;
        pointer-events: none;
    }
    ...
    .slide-3 { background-image: linear-gradient(rgba(0, 51, 102, 0.5), rgba(0, 102, 153, 0.3)), url('/image/hutaginjang/Hutaginjang_4.jpg'); }
...
<section class="hero-section" id="home">
    ...
    <div class="hero-content">
        <div>
            ...
            <h1 class="hero-title"> Huta Ginjang</h1>
            ...
            <div class="maps-info">
                <div class="maps-locations">
                    ...
                    <div class="maps-location-item" 
                        onclick="window.open('https://www.google.com/maps/place/Huta+Ginjang,+Kec.+Muara,+Kabupaten+Tapanuli+Utara,+Sumatera+Utara/@2.315047,98.9750175,14z/data=!3m1!4b1!4m6!3m5!1s0x302e1b023a996c47:0x9c5750426f12a369!8m2!3d2.3083786!4d98.9742237!16s%2Fg%2F1pxxnzb1y?entry=ttu&g_ep=EgoyMDI2MDUyNS4wIKXMDSoASAFQAw%3D%3D', '_blank')">
                        <i class="fas fa-location-dot"></i>
                        <span>Huta Ginjang</span>
                    </div>
                </div>
